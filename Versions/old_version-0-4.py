...
def main():
    ...
    pygame.display.set_caption("Version 0\MOD(bg4)")
    ...
    level = [
       "PPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPP",
        ...
        "P                                                           P      P",
        "P                                                          PP      P",
        "P                                                     P     P      PPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPP",
        "P                                        P                  P                                                       P",                  
        "PPPPPPPPP                          P              P         P                                                       P",
        "P                            P               P              P       P      P                                        P",
        "P              P       P                                    P       P      P                                        P",
        "PSSSSSSSSCPPSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSP      PPPPPPPPPPPSSSSSSPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPEP",
        "                                                   PSSSSSSP                                                          ",]                                                                  
